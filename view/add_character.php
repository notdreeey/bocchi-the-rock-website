...
<form action="index.php?command=insertCharacter" method="POST" enctype="multipart/form-data">
    ...
    <label for="imageUpload" class="custom-file-button" style="border: 1px solid #ccc; color: #ffff;">Upload Image</label>
    ...
    <input type="reset" value="Reset Form" onclick="resetForm()"></div>
